...
public class AbstractScalaCodegenV3 extends DefaultCodegenConfig {
    protected String modelPropertyNaming = "camelCase";
    protected String sourceFolder = "src/main/scala";

    public AbstractScalaCodegenV3() {
        super();
    ...
    public String getTypeDeclaration(Schema propertySchema) {
        ...
        if (extensions != null && extensions.containsKey("x-scalaType")) {
            return extensions.get("x-scalaType").toString();
        }
